-- Recreate get_message_by_id to include quoted message source and source_metadata
...
-- Recreate get_messages to include quoted message source and source_metadata
