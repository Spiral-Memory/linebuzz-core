-- Add sync_to_slack column to messages table
ALTER TABLE "public"."messages" ADD COLUMN "sync_to_slack" boolean DEFAULT false NOT NULL;

-- Drop the old create_message function to avoid overloading conflicts
DROP FUNCTION IF EXISTS "public"."create_message"(uuid, text, uuid, uuid, jsonb);

-- Recreate the create_message function with the additional p_sync_to_slack parameter
...
EXECUTE FUNCTION supabase_functions.http_request('http://host.docker.internal:54321/functions/v1/slack-notify', 'POST', '{"content-type":"application/json","x-webhook-secret":"test_secret"}', '{}', '5000');
